 ...
 */
  ...
  static private  org.apache.spark.rdd.RDD<org.apache.spark.sql.catalyst.InternalRow> mergeWithPartitionValues (org.apache.spark.sql.types.StructType schema, java.lang.String[] requiredColumns, java.lang.String[] partitionColumns, org.apache.spark.sql.catalyst.InternalRow partitionValues, org.apache.spark.rdd.RDD<org.apache.spark.sql.catalyst.InternalRow> dataRows) { throw new RuntimeException(); }
  ...
  static protected  org.apache.spark.sql.execution.SparkPlan pruneFilterProjectRaw (org.apache.spark.sql.execution.datasources.LogicalRelation relation, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.NamedExpression> projects, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression> filterPredicates, scala.Function2<scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute>, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression>, org.apache.spark.rdd.RDD<org.apache.spark.sql.catalyst.InternalRow>> scanBuilder) { throw new RuntimeException(); }
  /**
