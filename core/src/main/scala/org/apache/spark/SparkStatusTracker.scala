 ...
 * Low-level status reporting APIs for monitoring job and stage progress.
  * 用于监控作业和阶段进度的低级状态报告API(Spark状态追踪器)
 *
 ...
 * 这些API有意提供非常弱的一致性语义,这些API的消费者应该准备好处理空/丢失的信息,
  * 例如,作业的阶段id可能是已知的,但是状态API可能没有关于这些阶段的细节的任何信息,因此getStageInfo'可能会为有效的阶段id返回 None。
 ...
 *  spark.ui.retainedJobs  jobs.
  *
 * 为了限制内存使用量,这些API仅提供有关最近作业/阶段的信息,这些API将为最后一个“spark.ui.retainedStages”阶段
  * 和“spark.ui.retainedJobs”作业提供信息。
